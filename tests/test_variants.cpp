...
INSTANTIATE_TEST_SUITE_P(BasicHaplotypes, VariantTest, ::testing::Values(basic_data));
...
INSTANTIATE_TEST_SUITE_P(OverlappingVariants, VariantTest, ::testing::Values(overlap_data));
...
INSTANTIATE_TEST_SUITE_P(SkipOverlaps, VariantTest, ::testing::Values(overlap_skip_data));
